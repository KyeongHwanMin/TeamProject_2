						...
						<div
							...
							<div class="main_nav_container ml-auto">
								<ul class="main_nav_list">
									...
									<li class="main_nav_item"><a href="/userpage/attraction/history.jsp">관광지</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col text-center">
							...
							<h2 class="section_title"><a href="/userpage/attraction/history.jsp">#역사/문화</a></h2>
						</div>
						<div class="col text-center">
							<h2 class="section_title"><a href="/userpage/attraction/history.jsp">#자연/경치</a></h2>
						</div>
						<div class="col text-center">
							<h2 class="section_title"><a href="/userpage/attraction/history.jsp">#레저/체험/학습</a></h2>
						</div>
						<div class="col text-center">
							<h2 class="section_title"><a href="/userpage/attraction/history.jsp">#휴식/힐링</a></h2>
						</div>
