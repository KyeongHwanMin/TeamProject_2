...
<center><b>글삭제</b>
<br>
<form method="POST" name="delForm"  action="/jejuguseok/WEB-INF/view/userpage/oto/otoDeletePro.do?num=${num}&otonum=${otonum}&pageNum=${pageNum}&level=${level}" onsubmit="return deleteSave()"> 
