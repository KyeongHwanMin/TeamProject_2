...
<center><b>글수정</b>
<br>
<form method="post" name="writeform" action="/jejuguseok/WEB-INF/view/userpage/oto/otoUpdatePro.do?pageNum=${pageNum}" onsubmit="return writeSave()">
<table width="400" border="1" cellspacing="0" cellpadding="0"  align="center">
  ...
  <tr>
    ...
    <td align="left" width="330" >
     <input type="file" name="img" value="${article.save}" /> <br />
	 </td>
  </tr>
  <tr>      
