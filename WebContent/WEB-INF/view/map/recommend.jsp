...
function pageNext(pageNum){
 ...
 <div class="button book_buttonn"><a href="accomLocal.do?search=1">20대</a></div>
 <div class="button book_buttonn"><a href="accomLocal.do?search=2">30대</a></div>
 <div class="button book_buttonn"><a href="accomLocal.do?search=3">40대</a></div>
 <div class="button book_buttonn"><a href="accomLocal.do?search=4">50대</a></div>
 <div class="button book_buttonn"><a href="accomLocal.do?search=5">2인이상</a></div>
 <div class="button book_buttonn"><a href="accomLocal.do?search=6">5인이상</a></div>
 </div>
		...
		<!-- Offers Grid : 숙소 리스트  -->
			...
			<c:if test="${count > 0}"> 
							...
							<c:forEach var="recommendCount" items="${recommendCount}" >
							<%-- 	<c:set var="cnt" value="${recommendCount.HOME_NO}"/>	
							 	<c:forEach var="recommendList" items="${recommendList}" >
							<c:set var="cntlist" value="${recommendList.HOME_NO}"/>
								<c:if test="${ cntlist == cnt }">--%>
