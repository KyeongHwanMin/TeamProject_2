...
<script type='text/javascript'>
    ...
    function create() {
        ...
        addDiv.innerHTML =  '<div id="card" class="card"><input type="text"  placeholder='+c_place+'>'+
        '  <textarea class="form-control" name="p_context" id="p_context" rows="6">'+c_context+'</textarea></div>'+
